...
/*** Custom Ouster in simu dataset***/
namespace ouster_simu
{
struct EIGEN_ALIGN16 Point
{
  PCL_ADD_POINT4D;
...
POINT_CLOUD_REGISTER_POINT_STRUCT(ouster_simu::Point, (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)
